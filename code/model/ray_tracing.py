...
class RayTracing(nn.Module):
    ...
    def forward(self,
        ...
        batch_size, num_pixels, _ = ray_directions.shape   #1*2048*3

        sphere_intersections, mask_intersect = util.get_sphere_intersection(cam_loc, ray_directions, r=self.object_bounding_sphere)
